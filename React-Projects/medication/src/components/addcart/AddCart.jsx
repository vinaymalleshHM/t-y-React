...
export default function AddCart(props) {
    ...
    const handleShow = async (length, amount) => {
        ...
        // })
          ...
          window.localStorage.setItem('buy',JSON.stringify(receiveItem.all));
        props.history.push("/check")
                    ...
                    <div className="col-md-6">
                        ...
                        {receiveItem.all.map((acc) => {
                            return (
                                ...
                                <div className='col-md-12 col-sm-8 col-12 mt-2 card'>
                                    <div key={acc.id} className='card-body'>
                                        <div className="col-md-3 float-right">
                                            <img className='card-img-top' width='100%' height='100px' alt="..." src={acc.proImg} alt='No Image' ></img>
                                        </div>
